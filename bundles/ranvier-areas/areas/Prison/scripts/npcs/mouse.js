      ...
      playerEnter: state => function (player) {
        ...
        const speak = state.EffectFactory.create('speak', this, {}, {
          messageList: [
            ...
            "Translation: Greetings, %player%, I am Miruk, the High Priest of Topedus. The Master, Topedus, wants you to bring forth idols as a proper offering to Master Topedus. Otherwise, we'll use your blood for the sacrifice."
          ],
          outputFn: message => {
